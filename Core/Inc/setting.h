...
// LED indication type
  ...
  // Names of types
  //SETT_TEXT_GATE_TYPE = SETT_TEXT_GATE_GROUP + GATE_GR_NUM,
  // Names of models
  //SETT_TEXT_GATE_MDL  = SETT_TEXT_GATE_TYPE + GATE_TYPE_NUM,
  // number of strings
  //SETT_TEXT_NUM       = SETT_TEXT_GATE_MDL + GATE_MDL_TTL_NUM
} SETTTEXTVAL;
